  ...
  render() {
    ...
    const drawer = (
      <div>
        ...
        <Divider />
        <List>
          {["Home", "Work Experience", "Projects", "Education"].map(
            (text, index) => (
              <ListItem
                button
                key={text}
              ...
              >
                <ListItemIcon>{this.renderIcon(text)}</ListItemIcon>
              ...
              {!this.state.mobile && (
                <Grid item>
                  <IconButton
                    ...
                    target="_blank"
                    href="https://tuckermillerresume.s3.us-east-2.amazonaws.com/Resume%2B9.15.2021.pdf"
                  >
